            ...
            <div className="max-w-[900px] m-[0_auto] py-[56px] relative">
                ...
                <div className="">
                    ...
                    <form action="" className="relative">
                        <input onKeyPress={(e) => e.key === 'Enter' && handlerInputSearch} value={inputValue} className="h-[48px] border-b-[3px] border-b-black px-[15px] w-[100%] outline-none text-[20px] text-black font-[500] leading-8" placeholder="#Giày BEESTYLE Chunky Liner" type="text" name="" id="" />
