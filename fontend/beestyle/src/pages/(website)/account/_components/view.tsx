...
const ViewAccount = (props: Props) => {
    ...
    const { register, handleSubmit, setValue } = useForm<TDanh>()
        ...
        <div className="flex flex-col">
            <div className="">
                <div className="flex items-center lg:hidden">
                    ...
                    <span className='text-[25px] font-[700]'>{user?.data.user.name}</span>
                </div>
                <div className="bg-purple-500 w-full p-[14px] my-[24px] rounded-[5px] lg:p-[22px_24px] lg:rounded-none lg:my-0">
                    <div className="flex justify-center items-center lg:hidden">
                        <svg className='mr-[10px]' xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none"> <path d="M21.5 9.42857L21.5 6L17.5 6" stroke="white" strokeWidth="1.2" strokeLinecap="square"></path> <path d="M7.5 6H3.5V9.42857" stroke="white" strokeWidth="1.2" strokeLinecap="square"></path> <path d="M7.5 18H3.5V14.5714" stroke="white" strokeWidth="1.2" strokeLinecap="square"></path> <path d="M21.5 14.5714L21.5 18L17.5 18" stroke="white" strokeWidth="1.2" strokeLinecap="square"></path> <line x1="6" y1="14.5" x2="6" y2="9.5" stroke="white" strokeLinecap="square"></line> <line x1="11" y1="14.5" x2="11" y2="9.5" stroke="white" strokeLinecap="square"></line> <line x1="16" y1="14.5" x2="16" y2="9.5" stroke="white" strokeLinecap="square"></line> <line x1="8.7" y1="14.2" x2="8.7" y2="9.8" stroke="white" strokeWidth="1.6" strokeLinecap="square"></line> <line x1="13.7" y1="14.2" x2="13.7" y2="9.8" stroke="white" strokeWidth="1.6" strokeLinecap="square"></line> <line x1="18.7" y1="14.2" x2="18.7" y2="9.8" stroke="white" strokeWidth="1.6" strokeLinecap="square"></line> </svg>
                        ...
                        <div key={index + 1} className="">
                            <div className="flex p-[15px] -mx-[15px] lg:m-0 lg:p-[16px_20px] border-t-[#dadada] border-t-[1px] border-b-[#dadada] border-b-[1px] justify-between bg-slate-100">
                                ...
                                <div className="text-right">
                                    <div className="font-[400]">Trạng thái: <span className='font-[700] text-[17px]'>{item.status_description}</span></div>
                                    <span className='text-[14px] text-[#787878] underline cursor-pointer'>Xem chi tiết</span>
                                </div>
                                        ...
                                        <div className='w-[100%] flex'>
                                            ...
                                            <div className="w-[calc(100%-120px)] pl-[16px] flex items-center">
                                                ...
                                                {item.status_bill === "delivered" ? (
                                                    <div className="">
                                                        <div className=" cursor-pointer rounded-[3px] text-center w-[80px] py-[4px] border-[1px] border-[#B01722] mb-[5px] text-[#B01722]">Đánh giá</div>
                                                ...
                                                {item.status_bill === "pending" && index == 0 ? (
                                                    <div className="">
                                                        <div className=" cursor-pointer rounded-[3px] text-center w-[120px] py-[4px] border-[1px] border-black mb-[5px] text-black">Hủy đơn hàng</div>
                                                    </div>
                                                ) : ""}
                                            </div>
                                        </div>
                ...
                <div className={`hidden fixed z-10 flex-col top-0`}>
                    <div className="fixed overflow-hidden rounded-[5px] bg-white z-20 top-[50%] translate-y-[-50%] left-[50%] translate-x-[-50%] min-w-[300px] max-w-[500px] max-h-[600px] w-[100%] p-[20px]">
                        <form action="" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {/* <input type="hidden" {...register("rating")} defaultValue={rating}/> */}
                            ...
                            <textarea {...register("comment")} id="" placeholder='Thêm đánh giá chi tiết tại đây...' className='w-[100%] bg-slate-100 p-[10px] rounded-[3px] outline-none'></textarea>
                            <div className="flex mt-5 justify-end">
                                <div className="cursor-pointer mr-5 text-black bg-slate-50 p-[10px_30px] rounded font-medium">
                                    Hủy
                                </div>
