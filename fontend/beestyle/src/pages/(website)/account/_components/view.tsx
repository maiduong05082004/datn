...
const ViewAccount = (props: Props) => {
    ...
    const status = [{ id: 1, name: "Tất cả" }, { id: 2, name: "Chưa thanh toán" }, { id: 3, name: "Đang chờ xử lý" }, { id: 4, name: "Đã xử lý" }, { id: 5, name: "Đang giao hàng" }, { id: 6, name: "Đã giao hàng" }, { id: 7, name: "Đã hủy/Trả hàng" }]
    ...
    return (
        <>
            ...
            <div className="flex flex-col">
                ...
                {isStep === 2 &&
                    order?.data?.bills
                        ?.filter((item: any) => item.status_bill === "pending" && item.payment_info.status === "pending")
                ...
                {isStep === 3 &&
                    order?.data?.bills
                        ?.filter((item: any) => item.status_bill === "pending" && item.payment_info.status === "paid")
                        .map((item: any, index: number) => (
                            <div key={item.id || index} className="">
                                <div className="flex p-[10px] -mx-[15px] lg:m-0 border-t-[#dadada] border-t-[1px] border-b-[#dadada] border-b-[1px] justify-between items-center bg-slate-100 lg:p-[15px]">
                                    <div className="items-center lg:flex">
                ...
                {isStep === 7 &&
                    order?.data?.bills
                        ?.filter((item: any) => item.status_bill === "canceled")
                        .map((item: any, index: number) => (
                            <div key={item.id || index} className="">
                                <div className="flex p-[10px] -mx-[15px] lg:m-0 border-t-[#dadada] border-t-[1px] border-b-[#dadada] border-b-[1px] justify-between items-center bg-slate-100 lg:p-[15px]">
                                    <div className="items-center lg:flex">
