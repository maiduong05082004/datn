    ...
    return (
        <>
            ...
            <div className="flex flex-col">
                <div className="flex justify-between overflow-x-auto whitespace-nowrap cursor-pointer *:p-[15px]">
                    <div className="border-b-black border-b-[3px]">Tất cả</div>
                    <div className="">Chờ thanh toán</div>
                    <div className="">Vận chuyển</div>
                    <div className="">Chờ giao hàng</div>
                    <div className="">Hoàn thành</div>
                    <div className="">Đã hủy</div>
                    <div className="">Trả hàng/hoàn tiền</div>
                </div>
                    ...
                    {order?.data.bills.length > 0 ?
                        order?.data?.bills.map((item: any, index: any) => (
                            <div key={index + 1} className="">
                                <div className="flex p-[10px] -mx-[15px] lg:m-0 border-t-[#dadada] border-t-[1px] border-b-[#dadada] border-b-[1px] justify-between bg-slate-100">
