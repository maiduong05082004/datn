        ...
        <div>
            ...
            <div className="">
                <div className="text-[16px] font-[700] lg:text-[20px] border-b-black lg:border-b-[3px] py-[10px] lg:mb-[16px]">
                    Có <span>{favorite?.data?.wishlist_items?.length || 0}</span> sản phẩm trong danh sách yêu thích
                </div>
                {favorite?.data?.wishlist_items?.length <= 0 ?
                    ...
                    <div className="">
                        <div className="-mx-[15px] p-[24px_20px] lg:mx-0">
                            {favorite?.data?.wishlist_items.map((item: any, index: any) => (
