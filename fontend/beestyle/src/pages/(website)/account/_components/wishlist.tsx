                        ...
                        <div className="-mx-[15px] p-[24px_20px] lg:mx-0">
                            {favorite?.data?.data.map((item: any, index: any) => (
                                <div className={` flex justify-between items-center`}>
                                    ...
                                    <div onClick={() => handleRemoveFromWishlist(item.id)} className="hidden w-[20%] cursor-pointer text-center border border-[#E8E8E8] rounded-[3px] text-[14px] py-[6px] px-[8px] lg:block">Xóa khỏi mục yêu thích</div>
                                    <div onClick={() => handleRemoveFromWishlist(item.id)} className="lg:hidden">
