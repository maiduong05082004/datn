                ...
                <div className="px-[15px] pc:px-[48px]">
                    ...
                    {comment?.data?.comment_list.length > 0 ? (
                        <div className="p-[15px] bg-slate-100">
                            ...
                            {comment?.data?.comment_list.filter((item: any) => item.like > 0).map((item: any) => (
                                <>
                                <div key={item?.comment_id} className="flex justify-start items-start border-b-[1px] border-b-[#e8e8e8] lg:py-[20px]">
                                    ...
                                    <div className="w-[calc(100%-40px)]">
                                        ...
                                        <div className="text-[16px]">
                                            ...
                                            <div className="text-[14px] font-[400]">Phân loại hàng: Màu: <span className='font-[500]'>{item.color}</span> - Size: <span className='font-[500]'>{item.size}</span></div>
                                        </div>
                                ...
                                <div className="">{item.reply_comment.length != 0 ? item.reply_comment[0].content : ""}</div>
                                </>
                            ))}
