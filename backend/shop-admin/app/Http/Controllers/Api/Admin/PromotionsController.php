...
class PromotionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'promotion_type' => 'required|in:shipping,discount,voucher_discount,first_order',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'discount_type' => 'required|in:amount,percent',
            'max_discount_amount' => 'nullable|required_if:discount_type,percent|numeric|min:0',
            'promotion_type' => 'required|in:shipping,product_discount,order_discount,first_order',
            'category_ids' => 'array|nullable',
            'category_ids.*' => 'exists:categories,id',
            'product_ids' => 'array|nullable',
            'product_ids.*' => 'exists:products,id',
